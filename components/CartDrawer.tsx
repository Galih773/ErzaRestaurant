        ...
        {cartItems.length > 0 && (
          <div className="p-6 bg-brand-light border-t border-green-100">
            ...
            <button 
              ...
              className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white py-4 rounded-full font-bold flex items-center justify-center gap-3 shadow-lg shadow-green-500/30 transition-all active:scale-95"
            >
