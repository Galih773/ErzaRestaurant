           ...
           <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4">
                 ...
                 <div className="border-l-4 border-brand-green pl-4">
                    ...
                    <p className="text-sm text-gray-500">Pelanggan Bahagia Uhuy</p>
                 </div>
              </div>
           </div>
        </div>
                 ...
                 <div className="space-y-8">
                    <div className="flex items-start gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-gray-400">Jl. Merdeka No. 45, Jakarta Selatan,<br/>DKI Jakarta, Indonesia 12000</p>
                       </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-gray-400">Setiap Hari: 10:00 - 22:00 WIB</p>
                       </div>
                    </div>
                 </div>
              </div>
